    ...
    <section class="oor-challenge-section">
        <div class="oor-challenge-left">
            ...
            <div class="oor-without-fear-images">
                <a href="#" class="oor-without-fear-image text-cuberto-cursor-1" data-text="Стать артистом">
                    <picture>
                ...
                <a href="#" class="oor-without-fear-image-2 text-cuberto-cursor-1" data-text="Стать артистом">
                    <picture>
        ...
        <div class="oor-challenge-right">
            ...
            <div class="oor-quality-content">
                ...
                <div class="oor-become-artist-container">
                    <button class="oor-become-artist-button">
                ...
                <div class="oor-quality-strength-images">
                    <a href="#" class="oor-quality-img-container-1 text-cuberto-cursor-1" data-text="Стать артистом">
                        <picture>
                    ...
                    <a href="#" class="oor-quality-img-container-2 text-cuberto-cursor-1" data-text="Стать артистом">
                        <picture>
