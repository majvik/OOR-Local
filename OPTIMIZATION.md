...
### Неделя 1: Структура и ACF
- [ ] Создание структуры WordPress темы
- [ ] Регистрация Custom Post Types
- [ ] Создание всех шаблонов страниц
- [ ] Настройка ACF Field Groups
- [ ] Тестирование редактирования контента

### Неделя 2: Оптимизация и производительность
